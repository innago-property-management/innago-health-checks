...
public class RabbitMqApprovalTests
{
    ...
    private const string ProjectFolder = "RabbitMqHealthCheck";
    private const string ProjectName = "Innago.Shared.HealthChecks.RabbitMq.csproj";

    static RabbitMqApprovalTests()
    {
        try
        {
    ...
    public Task ApproveApi(string framework)
    {
        ...
        string configuration = typeof(RabbitMqApprovalTests).Assembly.GetCustomAttribute<AssemblyConfigurationAttribute>()!.Configuration;
